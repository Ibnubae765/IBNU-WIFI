#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Modified by Gemini - Adding License & Animation
import sys
import subprocess
import os
import tempfile
...
import pathlib
import time
import requests # Membutuhkan library ini: pip install requests
...
# =================================================
# FITUR BARU: VERIFIKASI & ANIMASI (TIDAK MERUSAK KODE ASLI)
# =================================================

def animasi_suntik():
    """Animasi loading 1% sampai 100%"""
    print("\n\033[1;36m[*] Mempersiapkan Sistem...")
    for i in range(1, 101):
        time.sleep(0.03)  # Kecepatan animasi
        sys.stdout.write(f"\r\033[1;32m[+] Injecting Data: [{('█' * (i // 5)).ljust(20)}] {i}%")
        sys.stdout.flush()
    print("\n\033[1;32m[!] Done! Membuka Tools...\n")
    time.sleep(1)

def verifikasi_license():
    """Verifikasi lisensi dari GitHub"""
    url_raw = "https://raw.githubusercontent.com/Ibnubae765/license-system/main/license.txt"
    os.system('cls||clear')
    print("\033[1;33m" + "═"*45)
    print("         SISTEM VERIFIKASI LICENSE")
    print("═"*45 + "\033[0m")
    
    key_input = input("\033[1;37m[?] Masukkan License Key Anda: \033[0m").strip()
    
    try:
        print("\033[1;34m[*] Menghubungi Server...\033[0m")
        # Timeout ditambahkan agar sc tidak stuck jika internet lemot
        response = requests.get(url_raw, timeout=10)
        if response.status_code == 200:
            database_license = response.text.splitlines()
            if key_input in database_license:
                print("\033[1;32m[✔] License Valid! Akses Diberikan.\033[0m")
                time.sleep(1.5)
                return True
            else:
                print("\033[1;31m[✘] License Tidak Valid atau Kadaluarsa!\033[0m")
                print("\033[1;37mHubungi Owner untuk mendapatkan key.\033[0m")
                sys.exit()
        else:
            print("\033[1;31m[!] Gagal mengambil data lisensi dari GitHub.\033[0m")
            sys.exit()
    except Exception as e:
        print(f"\033[1;31m[!] Error Koneksi: {e}\033[0m")
        sys.exit()

# Jalankan proteksi sebelum masuk ke kode utama
verifikasi_license()
animasi_suntik()

# =================================================
# KODE ASLI DIMULAI DARI SINI (TIDAK ADA YANG DIUBAH)
# =================================================
...
╚═╝╚═════╝ ╚═╝  ╚═══╝ ╚═════╝        ╚══╝╚══╝ ╚═╝╚═╝     ╚═\033[1;36m2.0
\033[1;36m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
 \033[1;37mOwner   :            IBNU-IDSTORE
 \033[1;37mFacebook:            IBNU
 \033[1;37mGithub  :            Ibnu765
 \033[1;37mWhatsapp:            +6282181410507
 \033[1;31mJALANKAN PERINTAH DIBAWAH INI:
\033[1;31msudo python WifiHack.py -i wlan0 -K
 \033[1;31mBUTUH BANTUAN HUB : 082181410507

 \033[1;31mNote    :       KHUSUS ANDROID ROOT
\033[1;36m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
""")

# ... Lanjutkan dengan class NetworkAddress dan seterusnya sampai akhir ...
